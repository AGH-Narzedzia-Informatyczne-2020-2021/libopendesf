...
int main(void)
{
    ...
    uint8_t karta[16] = {losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj()};
    uint8_t serwer[16] = {losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj(), losuj()};

    uint8_t klucz[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01};
